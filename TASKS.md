...
- Added keyboard controls with explicit key capture and keydown handling:
  - Left/Right adjusts angle.
  - Up/Down adjusts power.
  - Space logs a fire message with angle and power.
- Added on-screen HUD text for current angle/power and controls to make input state visible without relying on browser console filters.
